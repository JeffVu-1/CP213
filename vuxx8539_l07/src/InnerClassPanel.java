...
public class InnerClassPanel extends JPanel {
	...
	public void itemStateChanged(final ItemEvent e) {
        ...
        String checkboxText = source.getText(); 
        if (e.getStateChange() == ItemEvent.SELECTED) {
            //checking the array defined below called "checkBoxesSelected" to see if it contains the name of the current checkbox that is activating
            //if it doesn't then add it to the array of strings
            if (!InnerClassPanel.this.checkBoxesSelected.contains(checkboxText)) {
                InnerClassPanel.this.checkBoxesSelected.add(checkboxText);
            }
            //else if it's not checked anymore then remove it from that array by passing it's name
